...
async function getdata(){
    let res = await fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/customer/${id}/${key}`)
...
fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/count/${key}`, countRequestOptions)
 ...
 fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/getTotalAmount/${key}`, subTotalRequestOptions)
   ...
   async function placeOrderFunction(event){
        ...
        fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/BillingService/addBill/${key}`, billRequestOptions)
        .then(response => response.text())
        ...
        fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/order/${key}`, orderRequestOptions)
        .then(response => response.text())
        .then(result => {
            console.log(result);
