...
fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/vegetable/${key}`, requestOptions)
...
window.onload=getdata()
 async function getdata(){
    let res = await fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/vegetables`)
    data = await res.json()
    console.log(data);
    console.log("yes");
    append(data)
...
//   document.querySelector("#removeVeg").addEventListener("submit",removeVegetable);
  ...
  async function removeVegetable(id){
   ...
   var requestOptions = {
    ...
    fetch(`https://theChef vegetables and Meatsdeployment-production.up.railway.app/vegetable/${id}/${key}`, requestOptions)
      .then(response => response.text())
      .then(result => {
         console.log(result);
